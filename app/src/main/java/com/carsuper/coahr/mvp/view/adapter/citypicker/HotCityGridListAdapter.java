 ...
 * @Date: 2018/2/8 21:22
 */
public class HotCityGridListAdapter extends RecyclerView.Adapter<HotCityGridListAdapter.GridViewHolder>{
    ...
    public HotCityGridListAdapter(Context context, List<CityEntity> data) {
