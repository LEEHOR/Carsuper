 ...
 */
public class MNeedToEvaluateFragment extends BaseFragment<MNeedToEvaluateContract.Presenter> implements MNeedToEvaluateContract.View, View.OnClickListener {
    @Inject
    MNeedToEvaluatePresenter mNeedToEvaluatePresenter;
    ...
    public static MNeedToEvaluateFragment newInstance(String order_Id) {
        MNeedToEvaluateFragment fragment = new MNeedToEvaluateFragment();
    ...
    @Override
    public MNeedToEvaluateContract.Presenter getPresenter() {
        return mNeedToEvaluatePresenter;
    }

    @Override
    public int bindLayout() {
        return R.layout.fragment_maintanceorder_need_to_evaluate;
    }
    ...
    public void initView() {
        ...
        tvGotoEvaluate.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_copy_order_number:
                ...
                break;
            case R.id.tv_goto_evaluate:
                start(ToEvaluateFragment.newInstance(order_id, ToEvaluateFragment.TYPE_SERVICE));
                break;
        }
