 ...
 */
public class MaintanceOrderDetailCommodityAdapter extends BaseQuickAdapter<MaintanceOrderDetailBean.JdataEntity.CommodityEntity,BaseViewHolder> {

    public MaintanceOrderDetailCommodityAdapter(List<MaintanceOrderDetailBean.JdataEntity.CommodityEntity> data) {
