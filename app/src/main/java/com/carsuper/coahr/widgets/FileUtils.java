...
import com.carsuper.coahr.utils.UrlConnectionPool;
...
//    }
	...
	public static boolean isCanDownload(String path, long length) {
        ...
        return length <= (availableSize - keepSize);
    }
		...
		Collections.sort(list, new Comparator<String>() {
			...
			public int compare(String object1, String object2) {
				try {
					...
					BigInteger t1 = new BigInteger(object1);
					BigInteger t2 = new BigInteger(object2);
