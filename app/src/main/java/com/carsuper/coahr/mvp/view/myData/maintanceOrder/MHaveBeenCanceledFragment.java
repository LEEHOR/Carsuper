 ...
 */
public class MHaveBeenCanceledFragment extends BaseFragment<MHaveBeenCanceledContract.Presenter> implements MHaveBeenCanceledContract.View,View.OnClickListener {
    @Inject
    MHaveBeenCanceledPresenter mHaveBeenCanceledPresenter;
    ...
    public static MHaveBeenCanceledFragment newInstance(String order_Id) {
        MHaveBeenCanceledFragment fragment = new MHaveBeenCanceledFragment();
    ...
    @Override
    public MHaveBeenCanceledContract.Presenter getPresenter() {
        return mHaveBeenCanceledPresenter;
    }

    @Override
    public int bindLayout() {
        return R.layout.fragment_maintanceorder_havebeen_cancel;
    }
