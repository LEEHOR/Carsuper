...
public class SimplePaddingOfCommodityEvaluateFragment  extends RecyclerView.ItemDecoration {
    private float dividerHeight;
    private Paint mPaint;
    public SimplePaddingOfCommodityEvaluateFragment(Context context) {
